...
#
# # sqlite3_create_db()
# # sqlite3_delete_table(r'\DB.sqlite3', 'users')
# # sqlite3_update_record(r'\DB.sqlite3',
# #                       'users', 'Surname', 'McGregor', 'Password', 'conorpass')
# # sqlite3_read_db(r'\DB.sqlite3',
# #                 'users')  # sqlite3_read_db(DB.sqlite3', 'users', 'Name')
# # Name may be replaced by any column
#
# # sqlite3_delete_record(r'\DB.sqlite3', 'users', 'Login', 'bekezhan')
#
...
#
#
# sqlite3_read_db(r'\DB.sqlite3', 'users')
